function md5(input: string): string {
  ...
  const ff = (
    ...
    addUnsigned(
      rotateLeft(addUnsigned(addUnsigned(a, f(b, c, d)), addUnsigned(x, ac)), s),
      b
    );
  ...
  const gg = (
    ...
    addUnsigned(
      rotateLeft(addUnsigned(addUnsigned(a, g(b, c, d)), addUnsigned(x, ac)), s),
      b
    );
  ...
  const hh = (
    ...
    addUnsigned(
      rotateLeft(addUnsigned(addUnsigned(a, h(b, c, d)), addUnsigned(x, ac)), s),
      b
    );
  ...
  const ii = (
    ...
    addUnsigned(
      rotateLeft(addUnsigned(addUnsigned(a, i(b, c, d)), addUnsigned(x, ac)), s),
      b
    );
